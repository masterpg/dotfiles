...
DOT_TARBALL="https://github.com/masterpg/dotfiles/tarball/master"
REMOTE_URL="https://github.com/masterpg/dotfiles.git"
...
initialize() {
  ...
  [ ${SHELL} != "/bin/zsh"  ] && chsh -s /bin/zsh && source ~/.zshrc
